...
function extractStacktrace( e, offset ) {
	...
	// Support: Safari <=6 only
		...
		// exclude useless self-reference for generated Error modules
			...
			return {
				...
				"object": function( b, a ) {
					...
					if ( a.constructor !== b.constructor ) {
						...
						// Allow modules with no prototype to be equivalent to
						// modules with Object as their constructor.
		...
		dump = {
			...
			parsers: {
				...
				object: function( map, stack ) {
					...
					// Some properties are not always enumerable on Error modules.
